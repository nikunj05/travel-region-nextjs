...
export default function Settings() {
  ...
  const [editingField, setEditingField] = useState<
    keyof UpdateUserSettingsRequest | null
  >(null);
    ...
    <div className={styles.settingsContainer}>
      ...
      <FormProvider {...methods}>
        <div className={`${styles.settingsForm} form-field`}>
          {/* Language and Currency Preferences Row */}
          <div className={`${styles.preferencesRow} form-group`}>
              ...
              >
                <div className={styles.fieldRow}>
                  ...
                  <button
                    ...
                    onClick={() =>
                      editingField === "mobile"
                        ? handleSaveField("mobile")
                        : handleEditField("mobile")
                    }
                    disabled={updating}
                  >
                ...
                <div
                  className={`${styles.selectwithinputfield} select-with-input`}
                >
