  ...
  return (
    ...
    <div className="container">
      <div className="heading_section">
        ...
        <p className="section-description mx-width-790">Explore our top picks, carefully curated from traveler trends and
          trusted reviews to help you find the perfect stay.</p>
      </div>
      <div className="destination-card-mian">
        <div className="destination-card d-flex card-first-row">
          <div className="destination-card-items">
            <Image src={popularDestinationsImg1} width={789} height={408} alt="Santorini, Greece"
              className="destination-card-image" />
            <div className="property-location-tag">
              <Image src={locationFillIcon} width={16} height={16} alt="location icon" /> Santorini,
              Greece
            </div>
            <div className="destination-card-inner-content">
              <p className="hotel-available-status d-flex align-items-center">
                <Image src={hotelsAvailableIcon} width={20} height={20} alt="hotel icon" /> 31 Hotels
                Available
              </p>
              <h5 className="destination-hotel-pricing">From $179 <span
                  className="destination-hotel-pricing-night">/night</span>
              </h5>
            </div>
            <div className="overlay">
              <div className="overlay-content">
                <a  href="#" className="d-flex justify-content-center view-more-details-btn">
          ...
          <div className="destination-card-items">
            <Image src={popularDestinationsImg2} width={379} height={408} alt="Dubai, UAE"
              className="destination-card-image" />
            <div className="property-location-tag">
              <Image src={locationFillIcon} width={16} height={16} alt="location icon" /> Dubai, UAE
            </div>
            <div className="destination-card-inner-content">
              <p className="hotel-available-status d-flex align-items-center">
                <Image src={hotelsAvailableIcon} width={20} height={20} alt="hotel icon" /> 31 Hotels
        ...
        <div className="destination-card d-flex">
          ...
          <div className="destination-card-items">
            <Image src={popularDestinationsImg3} width={379} height={408} alt="Navigo, Greece"
              className="destination-card-image" />
            <div className="property-location-tag">
              <Image src={locationFillIcon} width={16} height={16} alt="location icon" />Navigo,
              Greece
            </div>
            <div className="destination-card-inner-content">
              <p className="hotel-available-status d-flex align-items-center">
          ...
          <div className="destination-card-items">
            <Image src={popularDestinationsImg4} width={789} height={408} alt="Maldives"
              className="destination-card-image" />
            <div className="property-location-tag">
              <Image src={locationFillIcon} width={16} height={16} alt="location icon" /> Maldives
            </div>
            <div className="destination-card-inner-content">
              <p className="hotel-available-status d-flex align-items-center">
                <Image src={hotelsAvailableIcon} width={20} height={20} alt="hotel icon" /> 31 Hotels
