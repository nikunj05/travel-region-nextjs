...
const ImageModal: React.FC<ImageModalProps> = ({ isOpen, onClose }) => {
  const [selectedCategory, setSelectedCategory] = useState<keyof typeof hotelImageCategories>('overview');
    ...
    <div className="image-modal-overlay" onClick={onClose}>
      <div className="image-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="image-modal-header">
          <h2 className="hotel-name">ITC Maurya, a Luxury Collection Hotel, New Delhi</h2>
        ...
        <div className="category-navigation">
          {Object.entries(hotelImageCategories).map(([key, category]) => (
            <button
              ...
              onClick={() => setSelectedCategory(key as keyof typeof hotelImageCategories)}
            >
        ...
        {isImageViewerOpen && (
          <div className="image-viewer-container">
            ...
            <div className="main-image-container">
              <button className="nav-arrow nav-arrow-left" onClick={handlePreviousImage}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
